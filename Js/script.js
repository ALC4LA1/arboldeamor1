...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Att, ALC4LA";
...
function showCountdown() {
  ...
  function update() {
    ...
    container.innerHTML =
      `Ultima vez que jugamos: <b>${days}</b> días<br>` +
      `Proxima vez que juguemos: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
